...
void PipeCompiler::_initExtensions(const asmjit::CpuFeatures& features) noexcept {
  ...
  if (features.x86().hasAVX()       && features.x86().hasAVX512_F() &&
...
SimdWidth PipeCompiler::maxSimdWidthFromCpuFeatures() noexcept {
  ...
  if (hasAVX512() && is64Bit())
    return SimdWidth::k512;

  // Use 256-bit SIMD width if AVX2 is available.
  if (hasAVX2())
    return SimdWidth::k256;

  return SimdWidth::k128;
}

void PipeCompiler::initSimdWidth(SimdWidth simdWidth) noexcept {
...
x86::Mem PipeCompiler::tmpStack(uint32_t size) noexcept {
  ...
  if (!_tmpStack.baseId())
    _tmpStack = cc->newStack(64, 16, "tmpStack");
  return _tmpStack;
}
...
static constexpr OpcodeVInfo opcodeInfo2V[size_t(OpcodeVV::kMaxValue) + 1] = {
  ...
  DEFINE_OP(kIdPmovsxbw   , 0, kIntrin, kIdVpmovsxbw      , kIntrin, 0, 0, kNone, 0, 0x00u, kNone, k16, 0, kNA), // kCvtI8ToI16.
  DEFINE_OP(kIdPmovzxbw   , 0, kIntrin, kIdVpmovzxbw      , kIntrin, 0, 0, kNone, 0, 0x00u, kNone, k16, 0, kNA), // kCvtU8ToU16.
  ...
  DEFINE_OP(kIdPmovsxwd   , 0, kIntrin, kIdVpmovsxwd      , kIntrin, 0, 0, kNone, 0, 0x00u, kNone, k32, 0, kNA), // kCvtI16ToI32.
  DEFINE_OP(kIdPmovzxwd   , 0, kIntrin, kIdVpmovzxwd      , kIntrin, 0, 0, kNone, 0, 0x00u, kNone, k32, 0, kNA), // kCvtU16ToU32.
  DEFINE_OP(kIdPmovsxdq   , 0, kIntrin, kIdVpmovsxdq      , kIntrin, 0, 0, kNone, 0, 0x00u, kNone, k64, 0, kNA), // kCvtI32ToI64.
  DEFINE_OP(kIdPmovzxdq   , 0, kIntrin, kIdVpmovzxdq      , kIntrin, 0, 0, kNone, 0, 0x00u, kNone, k64, 0, kNA), // kCvtU32ToU64.
  ...
  DEFINE_OP(kIdRoundss    , 2, kSSE4_1, kIdVroundss       , kAVX   , 0, 0, kNone, 1, 0x0Bu, kF32S, k32, 4, kNA), // kTruncF32S.
  DEFINE_OP(kIdRoundsd    , 2, kSSE4_1, kIdVroundsd       , kAVX   , 0, 0, kNone, 1, 0x0Bu, kF64S, k64, 8, kNA), // kTruncF64S.
  DEFINE_OP(kIdRoundps    , 2, kSSE4_1, kIdVroundps       , kAVX   , 0, 0, kNone, 1, 0x0Bu, kF32V, k32, 4, kNA), // kTruncF32.
  DEFINE_OP(kIdRoundpd    , 2, kSSE4_1, kIdVroundpd       , kAVX   , 0, 0, kNone, 1, 0x0Bu, kF64V, k64, 8, kNA), // kTruncF64.
  DEFINE_OP(kIdRoundss    , 2, kSSE4_1, kIdVroundss       , kAVX   , 0, 0, kNone, 1, 0x09u, kF32S, k32, 4, kNA), // kFloorF32S.
  DEFINE_OP(kIdRoundsd    , 2, kSSE4_1, kIdVroundsd       , kAVX   , 0, 0, kNone, 1, 0x09u, kF64S, k64, 8, kNA), // kFloorF64S.
  DEFINE_OP(kIdRoundps    , 2, kSSE4_1, kIdVroundps       , kAVX   , 0, 0, kNone, 1, 0x09u, kF32V, k32, 4, kNA), // kFloorF32.
  DEFINE_OP(kIdRoundpd    , 2, kSSE4_1, kIdVroundpd       , kAVX   , 0, 0, kNone, 1, 0x09u, kF64V, k64, 8, kNA), // kFloorF64.
  DEFINE_OP(kIdRoundss    , 2, kSSE4_1, kIdVroundss       , kAVX   , 0, 0, kNone, 1, 0x0Au, kF32S, k32, 4, kNA), // kCeilF32S.
  DEFINE_OP(kIdRoundsd    , 2, kSSE4_1, kIdVroundsd       , kAVX   , 0, 0, kNone, 1, 0x0Au, kF64S, k64, 8, kNA), // kCeilF64S.
  DEFINE_OP(kIdRoundps    , 2, kSSE4_1, kIdVroundps       , kAVX   , 0, 0, kNone, 1, 0x0Au, kF32V, k32, 4, kNA), // kCeilF32.
  DEFINE_OP(kIdRoundpd    , 2, kSSE4_1, kIdVroundpd       , kAVX   , 0, 0, kNone, 1, 0x0Au, kF64V, k64, 8, kNA), // kCeilF64.
  DEFINE_OP(kIdRoundss    , 2, kSSE4_1, kIdVroundss       , kAVX   , 0, 0, kNone, 1, 0x08u, kF32S, k32, 4, kNA), // kRoundF32S.
  DEFINE_OP(kIdRoundsd    , 2, kSSE4_1, kIdVroundsd       , kAVX   , 0, 0, kNone, 1, 0x08u, kF64S, k64, 8, kNA), // kRoundF64S.
  DEFINE_OP(kIdRoundps    , 2, kSSE4_1, kIdVroundps       , kAVX   , 0, 0, kNone, 1, 0x08u, kF32V, k32, 4, kNA), // kRoundF32.
  DEFINE_OP(kIdRoundpd    , 2, kSSE4_1, kIdVroundpd       , kAVX   , 0, 0, kNone, 1, 0x08u, kF64V, k64, 8, kNA), // kRoundF64.
  ...
  DEFINE_OP(kIdSqrtss     , 2, kSSE2  , kIdVsqrtss        , kIntrin, 0, 0, kNone, 0, 0x00u, kF32S, k32, 4, kNA), // kSqrtF32S.
  DEFINE_OP(kIdSqrtsd     , 2, kSSE2  , kIdVsqrtsd        , kIntrin, 0, 0, kNone, 0, 0x00u, kF64S, k64, 8, kNA), // kSqrtF64S.
  ...
  DEFINE_OP(kIdCvtps2pd   , 2, kIntrin, kIdVcvtps2pd      , kIntrin, 0, 0, kNone, 0, 0x00u, kF32V, k64, 4, kLo), // kCvtF32LoToF64.
  DEFINE_OP(kIdCvtps2pd   , 2, kIntrin, kIdVcvtps2pd      , kIntrin, 0, 0, kNone, 0, 0x00u, kF32V, k64, 4, kHi), // kCvtF32HiToF64.
  DEFINE_OP(kIdCvtpd2ps   , 2, kIntrin, kIdVcvtpd2ps      , kIntrin, 0, 0, kNone, 0, 0x00u, kF64V, k32, 4, kLo), // kCvtF64ToF32Lo.
  DEFINE_OP(kIdCvtpd2ps   , 2, kIntrin, kIdVcvtpd2ps      , kIntrin, 0, 0, kNone, 0, 0x00u, kF64V, k32, 4, kHi), // kCvtF64ToF32Hi.
  DEFINE_OP(kIdCvtdq2pd   , 2, kIntrin, kIdVcvtdq2pd      , kIntrin, 0, 0, kNone, 0, 0x00u, kNone, k64, 4, kLo), // kCvtI32LoToF64.
  ...
  DEFINE_OP(kIdCvttpd2dq  , 2, kIntrin, kIdVcvttpd2dq     , kIntrin, 0, 0, kNone, 0, 0x00u, kF64V, k32, 4, kLo), // kCvtTruncF64ToI32Lo.
  ...
  DEFINE_OP(kIdCvtpd2dq   , 2, kIntrin, kIdVcvtpd2dq      , kIntrin, 0, 0, kNone, 0, 0x00u, kF64V, k32, 4, kLo), // kCvtRoundF64ToI32Lo.
...
static constexpr OpcodeVInfo opcodeInfo2VI[size_t(OpcodeVVI::kMaxValue) + 1] = {
  DEFINE_OP(kIdPsllw      , 2, kSSE2  , kIdVpsllw         , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k16, 0, kNA), // kSllU16.
  DEFINE_OP(kIdPslld      , 2, kSSE2  , kIdVpslld         , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k32, 4, kNA), // kSllU32.
  DEFINE_OP(kIdPsllq      , 2, kSSE2  , kIdVpsllq         , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k64, 8, kNA), // kSllU64.
  DEFINE_OP(kIdPsrlw      , 2, kSSE2  , kIdVpsrlw         , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k16, 0, kNA), // kSrlU16.
  DEFINE_OP(kIdPsrld      , 2, kSSE2  , kIdVpsrld         , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k32, 4, kNA), // kSrlU32.
  DEFINE_OP(kIdPsrlq      , 2, kSSE2  , kIdVpsrlq         , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k64, 8, kNA), // kSrlU64.
  DEFINE_OP(kIdPsraw      , 2, kSSE2  , kIdVpsraw         , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k16, 0, kNA), // kSraI16.
  DEFINE_OP(kIdPsrad      , 2, kSSE2  , kIdVpsrad         , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k32, 4, kNA), // kSraI32.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdVpsraq         , kAVX512, 0, 0, kNone, 0, 0x00u, kNone, k64, 8, kNA), // kSraI64.
  DEFINE_OP(kIdPslldq     , 2, kSSE2  , kIdVpslldq        , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k8 , 0, kNA), // kSllbU128.
  DEFINE_OP(kIdPsrldq     , 2, kSSE2  , kIdVpsrldq        , kAVX   , 0, 0, kNone, 0, 0x00u, kNone, k8 , 0, kNA), // kSrlbU128.
...
static constexpr OpcodeVInfo opcodeInfo3V[size_t(OpcodeVVV::kMaxValue) + 1] = {
  ...
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 1, 0, kNone, 0, 0x00u, kNone, k16, 0, kNA), // kMulU64_LoU32.
  ...
  DEFINE_OP(kIdMinps      , 2, kSSE2  , kIdVminps         , kAVX   , 1, 0, kSrc , 0, 0x00u, kF32V, k32, 4, kNA), // kMinF32.
  DEFINE_OP(kIdMinpd      , 2, kSSE2  , kIdVminpd         , kAVX   , 1, 0, kSrc , 0, 0x00u, kF64V, k64, 8, kNA), // kMinF64.
  ...
  DEFINE_OP(kIdMaxps      , 2, kSSE2  , kIdVmaxps         , kAVX   , 1, 0, kSrc , 0, 0x00u, kF32V, k32, 4, kNA), // kMaxF32.
  DEFINE_OP(kIdMaxpd      , 2, kSSE2  , kIdVmaxpd         , kAVX   , 1, 0, kSrc , 0, 0x00u, kF64V, k64, 8, kNA), // kMaxF64.
  ...
  DEFINE_OP(kIdCmpss      , 2, kIntrin, kIdVcmpss         , kAVX   , 1, 1, kNone, 1, 0x0Cu, kF32S, k32, 4, kNA), // kCmpNeF32S    (ne ordered quiet).
  DEFINE_OP(kIdCmpsd      , 2, kIntrin, kIdVcmpsd         , kAVX   , 1, 1, kNone, 1, 0x0Cu, kF64S, k64, 8, kNA), // kCmpNeF64S    (ne ordered quiet).
  DEFINE_OP(kIdCmpps      , 2, kIntrin, kIdVcmpps         , kAVX   , 1, 1, kNone, 1, 0x0Cu, kF32V, k32, 4, kNA), // kCmpNeF32     (ne ordered quiet).
  DEFINE_OP(kIdCmppd      , 2, kIntrin, kIdVcmppd         , kAVX   , 1, 1, kNone, 1, 0x0Cu, kF64V, k64, 8, kNA), // kCmpNeF64     (ne ordered quiet).
  ...
  DEFINE_OP(kIdHaddpd     , 2, kSSE3  , kIdVhaddpd        , kAVX   , 0, 0, kNone, 0, 0x00u, kF64V, k64, 0, kNA), // kHAddF64.
...
static constexpr OpcodeVInfo opcodeInfo4V[size_t(OpcodeVVV::kMaxValue) + 1] = {
  ...
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF32S, k32, 4, kNA), // kMSubF32S.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF64S, k64, 8, kNA), // kMSubF64S.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF32V, k32, 4, kNA), // kMSubF32.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF64V, k64, 8, kNA), // kMSubF64.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF32S, k32, 4, kNA), // kNMAddF32S.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF64S, k64, 8, kNA), // kNMAddF64S.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF32V, k32, 4, kNA), // kNMAddF32.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF64V, k64, 8, kNA), // kNMAddF64.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF32S, k32, 4, kNA), // kNMSubF32S.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF64S, k64, 8, kNA), // kNMSubF64S.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF32V, k32, 4, kNA), // kNMSubF32.
  DEFINE_OP(kIdNone       , 0, kIntrin, kIdNone           , kIntrin, 0, 0, kNone, 0, 0x00u, kF64V, k64, 8, kNA)  // kNMSubF64.
};
...
static BL_INLINE uint32_t shufImm2FromSwizzleWithWidth(Swizzle2 s, SimdWidth w) noexcept {
...
static BL_NOINLINE void sseRound(PipeCompiler* pc, const Vec& dst, const Operand& src, FloatMode fm, x86::RoundImm roundMode) noexcept {
  ...
  if (fm == FloatMode::kF32S || fm == FloatMode::kF32V) {
    ...
    magic = pc->simdConst(&pc->ct.f32_round_magic, Bcst::k32, dst);
  }
  else {
    maxn = pc->simdConst(&pc->ct.f64_round_max, Bcst::k64, dst);
    magic = pc->simdConst(&pc->ct.f64_round_magic, Bcst::k64, dst);
  }
  ...
  if (roundMode == x86::RoundImm::kNearest) {
    ...
    //     float maxn   = pow(2, 22);
    //     float magic0 = pow(2, 22) + pow(2, 21);
    ...
    cc->emit(fi.fmov, tmp, dst);
    cc->emit(fi.fcmp, tmp, maxn, x86::CmpImm::kLT);
    cc->emit(fi.fand, tmp, magic);
  ...
  if (roundMode == x86::RoundImm::kTrunc) {
    ...
    cc->emit(fi.fadd, t2, magic);
    cc->emit(fi.fmov, t3, t1);

    cc->emit(fi.fsub, t2, magic);
    cc->emit(fi.fcmp, t1, maxn, x86::CmpImm::kNLT);
...
static BL_NOINLINE void avxMov(PipeCompiler* pc, const Vec& dst, const Operand_& src) noexcept {
  ...
  if (src.isMem())
    cc->emit(Inst::kIdVmovdqu, dst, src);
  else if (dst.id() != src.id())
    cc->emit(Inst::kIdVmovdqa, dst, src);
}
  ...
  if (hasAVX()) {
    ...
    switch (op) {
      ...
      case OpcodeVV::kBroadcastF64: {
        ...
        if (!hasAVX2()) {
          ...
          if (elementSize <= ElementSize::k16) {
            ...
            Vec pred = simdVecConst(predData, dstXmm);
      ...
      case OpcodeVV::kBroadcastV128_F64: {
        ...
        // Cannot broadcast 128-bit vector to a 128-bit vector...
        if (dst.isXmm()) {
          avxMov(this, dst, src);
          return;
        }
      ...
      case OpcodeVV::kCvtI8ToI16:
      case OpcodeVV::kCvtU8ToU16:
      case OpcodeVV::kCvtI16ToI32:
      case OpcodeVV::kCvtU16ToU32:
      case OpcodeVV::kCvtI32ToI64:
      case OpcodeVV::kCvtU32ToU64: {
        if (src.isReg())
      ...
      case OpcodeVV::kAbsF64: {
        ...
        const void* mskData = op == OpcodeVV::kAbsF32 ? static_cast<const void*>(&ct.f32_abs)
                                                      : static_cast<const void*>(&ct.f64_abs);
      ...
      case OpcodeVV::kRcpF32: {
        ...
        if (isSameVec(dst, src) && one.isMem()) {
          Vec tmp = newSimilarReg(dst, "@tmp");
          avxMov(this, tmp, one);
          one = tmp;
        }
      ...
      case OpcodeVV::kRoundF64S: {
        ...
        cc->emit(instId, dst, dst, src, uint32_t(opInfo.imm));
        return;
      }
      ...
      case OpcodeVV::kCvtF64ToF32S: {
        // Intrinsic - these instructions use 3 operand form for historical reasons.
        Vec zeros = simdVecConst(&ct.i128_0000000000000000, dst);
      ...
      case OpcodeVV::kCvtI32HiToF64: {
        ...
        if (src.isReg()) {
          Vec tmp = newVec(SimdWidth(w), "@tmp");
          ...
          if (dst.isZmm()) {
            ...
            cc->vpshufd(tmp, src.as<Vec>(), x86::shuffleImm(3, 2, 3, 1));
            cc->emit(instId, dst, tmp);
          }
        }
        else {
          src.as<Mem>().setSize(w * 16u);
          src.as<Mem>().addOffset(w * 16u);
          cc->emit(instId, dst, src);
        }
    ...
    switch (op) {
      ...
      case OpcodeVV::kCvtU32ToU64: {
        ...
        WideningOp cvt {};
        switch (op) {
          case OpcodeVV::kCvtI8ToI16 : cvt = WideningOp::kI8ToI16; break;
          case OpcodeVV::kCvtU8ToU16 : cvt = WideningOp::kU8ToU16; break;
          case OpcodeVV::kCvtI16ToI32: cvt = WideningOp::kI16ToI32; break;
          case OpcodeVV::kCvtU16ToU32: cvt = WideningOp::kU16ToU32; break;
          case OpcodeVV::kCvtI32ToI64: cvt = WideningOp::kI32ToI64; break;
          case OpcodeVV::kCvtU32ToU64: cvt = WideningOp::kU32ToU64; break;
          default:
            BL_NOT_REACHED();
        }
  ...
  if (hasAVX()) {
    ...
    switch (op) {
      ...
      case OpcodeVVI::kSwizzleU16x4: {
        ...
        // TODO: Use VPSHUFB instead where appropriate.
      ...
      case OpcodeVVI::kSwizzleF64x2: {
        ...
        if (Swizzle2{imm} == swizzle(0, 0) && !dst.isZmm()) {
          ...
          uint32_t shufImm = shufImm2FromSwizzleWithWidth(Swizzle2{imm}, SimdWidthUtils::simdWidthOf(dst));
  ...
  if (hasAVX()) {
    ...
    switch (op) {
      ...
      case OpcodeVR::kExtractU64: {
        ...
        if (op == OpcodeVR::kExtractU64 && idx == 0) {
  ...
  if (hasAVX()) {
    ...
    switch (op) {
      ...
      case OpcodeVM::kLoadInsertU64: {
        ...
        else if (op == OpcodeVM::kLoadInsertU8) {
          Gp tmp = newGp32("@tmp");
          src.setSize(1);
          cc->pextrw(tmp, dst.as<Xmm>(), idx / 2u);
          if (idx & 1)
        ...
        else if (op == OpcodeVM::kLoadInsertU32) {
          if (idx == 0) {
            Vec tmp = newV128("@tmp");
...
void PipeCompiler::emit_mv(OpcodeMV op, const Mem& dst_, const Vec& src_, uint32_t alignment) noexcept {
...
void PipeCompiler::emit_mv(OpcodeMV op, const Mem& dst_, const OpArray& src_, uint32_t alignment) noexcept {
  Mem dst(dst_);
  ...
  if (hasAVX()) {
    ...
    switch (op) {
      ...
      case OpcodeVVV::kMulU64_LoU32: {
        ...
        if (hasAVX512()) {
          Vec msk = simdVecConst(&ct.i_FFFFFFFF00000000, dst);
      ...
      case OpcodeVVV::kCombineLoHiF64: {
        ...
        uint32_t shufImm = shufImm2FromSwizzleWithWidth(swizzle(0, 1), SimdWidthUtils::simdWidthOf(dst));
      ...
      case OpcodeVVV::kCombineHiLoF64: {
        ...
        if (dst.isXmm()) {
          cc->emit(Inst::kIdVmovsd, dst, src1v, src2);
          return;
        }
        ...
        uint32_t shufImm = shufImm2FromSwizzleWithWidth(swizzle(1, 0), SimdWidthUtils::simdWidthOf(dst));
        cc->emit(Inst::kIdVshufpd, dst, src2, src1v, shufImm);
        return;
      }
    ...
    switch (op) {
      ...
      case OpcodeVVV::kHAddF64: {
        ...
        if (isSameVec(src1v, src2)) {
          ...
          cc->unpckhpd(tmp.as<Xmm>(), src1v.as<Xmm>());
      ...
      case OpcodeVVV::kCombineHiLoF64: {
        ...
        if (src2.isMem()) {
          ...
          cc->emit(Inst::kIdMovhlps, dst, src1v);
        }
        else {
  ...
  if (hasAVX()) {
    ...
    switch (op) {
      ...
      case OpcodeVVVI::kInterleaveShuffleF64x2: {
        ...
        if (op == OpcodeVVVI::kInterleaveShuffleU32x4 || op == OpcodeVVVI::kInterleaveShuffleF32x4)
          shufImm = shufImm4FromSwizzle(Swizzle4{imm});
        else
          shufImm = shufImm2FromSwizzle(Swizzle2{imm});

        if (isSameVec(src1v, src2)) {
          OpcodeVVI vvi_op =  OpcodeVVI(size_t(OpcodeVVI::kSwizzleU32x4) + (size_t(op) - size_t(OpcodeVVVI::kInterleaveShuffleU32x4)));
...
void PipeCompiler::emit_4v(OpcodeVVVV op, const Operand_& dst_, const Operand_& src1_, const Operand_& src2_, const Operand_& src3_) noexcept {
  ...
  if (hasAVX()) {
      ...
      case OpcodeVVVV::kNMSubF64: {
        ...
        if (hasFMA()) {
          ...
          if (fmaId < 8u) {
            ...
            InstId fi_facc = fmaId < 4u ? fi.fadd : fi.fsub;
    ...
    switch (op) {
      case OpcodeVVVV::kBlendV_U8: {
        // Blend(a, b, cond) == (a & ~cond) | (b & cond)
        if (hasSSE4_1() && isSameVec(dst, src1)) {
          sseMakeVec(this, src3, "tmp");
          cc->emit(opInfo.sseInstId, dst, src1, src2, src3);
          return;
        }
      ...
      case OpcodeVVVV::kNMSubF64: {
        ...
        const FloatInst& fi = sse_float_inst[size_t(fm)];
        InstId fi_facc = op <= OpcodeVVVV::kMAddF64 ? fi.fadd : fi.fsub;

        if (isSameVec(dst, src3)) {
          src3 = sseCopy(this, src3.as<Vec>(), "@copy_src3");
        }

        if (op <= OpcodeVVVV::kMSubF64)
