...
void PipeCompiler::initSimdWidth(SimdWidth simdWidth) noexcept {
  BL_ASSERT(simdWidth == SimdWidth::k128);
  blUnused(simdWidth);

  _simdWidth = SimdWidth::k128;
  _simdRegType = RegType::kVec128;
  _simdTypeId = asmjit::TypeId::kInt32x4;
  _simdMultiplier = 1u;
}
...
Mem PipeCompiler::simdMemConst(const void* c, Bcst bcstWidth, SimdWidth constWidth) noexcept {
...
Vec PipeCompiler::simdConst16B(const void* data16) noexcept {
  ...
  Vec vReg = newVec(SimdWidth::k128, "const");
...
Mem PipeCompiler::tmpStack(uint32_t size) noexcept {
  ...
  if (src2.isImm()) {
    ...
    switch (op) {
      ...
      case OpcodeRRR::kSub: {
        ...
        // TODO: Just testing the idea of patching the previous instruction to have a post-index addressing.
...
static constexpr OpcodeVInfo opcodeInfo2V[size_t(OpcodeVV::kMaxValue) + 1] = {
  ...
  DEFINE_OP(Inst::kIdSshll_v        , kIntrin, 0, 0, 0, kNone, kNone, k16, kNA, k8 , kLo, 0x00u), // kCvtI8ToI16
  DEFINE_OP(Inst::kIdUshll_v        , kIntrin, 0, 0, 0, kNone, kNone, k16, kNA, k8 , kLo, 0x00u), // kCvtU8ToU16
  ...
  DEFINE_OP(Inst::kIdSshll_v        , kIntrin, 0, 0, 0, kNone, kNone, k32, kNA, k16, kLo, 0x00u), // kCvtI16ToI32
  DEFINE_OP(Inst::kIdUshll_v        , kIntrin, 0, 0, 0, kNone, kNone, k32, kNA, k16, kLo, 0x00u), // kCvtU16ToU32
  DEFINE_OP(Inst::kIdSshll_v        , kIntrin, 0, 0, 0, kNone, kNone, k64, kNA, k32, kLo, 0x00u), // kCvtI32ToI64
  DEFINE_OP(Inst::kIdUshll_v        , kIntrin, 0, 0, 0, kNone, kNone, k64, kNA, k32, kLo, 0x00u), // kCvtU32ToU64
...
static constexpr OpcodeVInfo opcodeInfo3V[size_t(OpcodeVVV::kMaxValue) + 1] = {
  ...
  DEFINE_OP(Inst::kIdFmin_v         , kASIMD , 1, 0, 0, kSrc , kF32S, k32, kNA, k32, kNA, 0x00u), // kMinF32S.
  DEFINE_OP(Inst::kIdFmin_v         , kASIMD , 1, 0, 0, kSrc , kF64S, k64, kNA, k64, kNA, 0x00u), // kMinF64S.
  DEFINE_OP(Inst::kIdFmin_v         , kASIMD , 1, 0, 0, kSrc , kF32V, k32, kNA, k32, kNA, 0x00u), // kMinF32.
  DEFINE_OP(Inst::kIdFmin_v         , kASIMD , 1, 0, 0, kSrc , kF64V, k64, kNA, k64, kNA, 0x00u), // kMinF64.
  DEFINE_OP(Inst::kIdFmax_v         , kASIMD , 1, 0, 0, kSrc , kF32S, k32, kNA, k32, kNA, 0x00u), // kMaxF32S.
  DEFINE_OP(Inst::kIdFmax_v         , kASIMD , 1, 0, 0, kSrc , kF64S, k64, kNA, k64, kNA, 0x00u), // kMaxF64S.
  DEFINE_OP(Inst::kIdFmax_v         , kASIMD , 1, 0, 0, kSrc , kF32V, k32, kNA, k32, kNA, 0x00u), // kMaxF32.
  DEFINE_OP(Inst::kIdFmax_v         , kASIMD , 1, 0, 0, kSrc , kF64V, k64, kNA, k64, kNA, 0x00u), // kMaxF64.
  ...
  DEFINE_OP(Inst::kIdNone           , kIntrin, 1, 1, 0, kNone, kF32S, k32, kNA, k32, kNA, 0x00u), // kCmpNeF32S    (ne ordered quiet).
  DEFINE_OP(Inst::kIdNone           , kIntrin, 1, 1, 0, kNone, kF64S, k64, kNA, k64, kNA, 0x00u), // kCmpNeF64S    (ne ordered quiet).
  DEFINE_OP(Inst::kIdNone           , kIntrin, 1, 1, 0, kNone, kF32V, k32, kNA, k32, kNA, 0x00u), // kCmpNeF32     (ne ordered quiet).
  DEFINE_OP(Inst::kIdNone           , kIntrin, 1, 1, 0, kNone, kF64V, k64, kNA, k64, kNA, 0x00u), // kCmpNeF64     (ne ordered quiet).
  ...
  DEFINE_OP(Inst::kIdSmull_v        , kASIMD , 0, 0, 0, kNone, kNone, k16, kNA, k8 , kHi, 0x00u), // kMulwHiI8.
  DEFINE_OP(Inst::kIdUmull_v        , kASIMD , 0, 0, 0, kNone, kNone, k16, kNA, k8 , kHi, 0x00u), // kMulwHiU8.
  ...
  DEFINE_OP(Inst::kIdSmull_v        , kASIMD , 0, 0, 0, kNone, kNone, k32, kNA, k16, kHi, 0x00u), // kMulwHiI16.
  DEFINE_OP(Inst::kIdUmull_v        , kASIMD , 0, 0, 0, kNone, kNone, k32, kNA, k16, kHi, 0x00u), // kMulwHiU16.
  ...
  DEFINE_OP(Inst::kIdSmull_v        , kASIMD , 0, 0, 0, kNone, kNone, k64, kNA, k32, kHi, 0x00u), // kMulwHiI32.
  DEFINE_OP(Inst::kIdUmull_v        , kASIMD , 0, 0, 0, kNone, kNone, k64, kNA, k32, kHi, 0x00u), // kMulwHiU32.
  ...
  DEFINE_OP(Inst::kIdSmlal_v        , kASIMD , 0, 0, 0, kNone, kNone, k16, kNA, k8 , kHi, 0x00u), // kMAddwHiI8.
  DEFINE_OP(Inst::kIdUmlal_v        , kASIMD , 0, 0, 0, kNone, kNone, k16, kNA, k8 , kHi, 0x00u), // kMAddwHiU8.
  ...
  DEFINE_OP(Inst::kIdSmlal_v        , kASIMD , 0, 0, 0, kNone, kNone, k32, kNA, k16, kHi, 0x00u), // kMAddwHiI16.
  DEFINE_OP(Inst::kIdUmlal_v        , kASIMD , 0, 0, 0, kNone, kNone, k32, kNA, k16, kHi, 0x00u), // kMAddwHiU16.
  ...
  DEFINE_OP(Inst::kIdSmlal_v        , kASIMD , 0, 0, 0, kNone, kNone, k64, kNA, k32, kHi, 0x00u), // kMAddwHiI32.
  DEFINE_OP(Inst::kIdUmlal_v        , kASIMD , 0, 0, 0, kNone, kNone, k64, kNA, k32, kHi, 0x00u)  // kMAddwHiU32.
};
...
static constexpr OpcodeVMInfo opcodeInfo2VM[size_t(OpcodeVM::kMaxValue) + 1] = {
  DEFINE_OP(WideningOp::kNone    ,  1, k8 ), // kLoad8.
  DEFINE_OP(WideningOp::kNone    ,  2, k16), // kLoad16_U16.
  DEFINE_OP(WideningOp::kNone    ,  4, k32), // kLoad32_U32.
  DEFINE_OP(WideningOp::kNone    ,  4, k32), // kLoad32_F32.
  DEFINE_OP(WideningOp::kNone    ,  8, k32), // kLoad64_U32.
  DEFINE_OP(WideningOp::kNone    ,  8, k64), // kLoad64_U64.
  DEFINE_OP(WideningOp::kNone    ,  8, k32), // kLoad64_F32.
  DEFINE_OP(WideningOp::kNone    ,  8, k64), // kLoad64_F64.
  DEFINE_OP(WideningOp::kNone    , 16, k32), // kLoad128_U32.
  DEFINE_OP(WideningOp::kNone    , 16, k64), // kLoad128_U64.
  DEFINE_OP(WideningOp::kNone    , 16, k32), // kLoad128_F32.
  DEFINE_OP(WideningOp::kNone    , 16, k64), // kLoad128_F64.
  DEFINE_OP(WideningOp::kNone    , 32, k32), // kLoad256_U32.
  DEFINE_OP(WideningOp::kNone    , 32, k64), // kLoad256_U64.
  DEFINE_OP(WideningOp::kNone    , 32, k32), // kLoad256_F32.
  DEFINE_OP(WideningOp::kNone    , 32, k64), // kLoad256_F64.
  DEFINE_OP(WideningOp::kNone    , 64, k32), // kLoad512_U32.
  DEFINE_OP(WideningOp::kNone    , 64, k64), // kLoad512_U64.
  DEFINE_OP(WideningOp::kNone    , 64, k32), // kLoad512_F32.
  DEFINE_OP(WideningOp::kNone    , 64, k64), // kLoad512_F64.
  DEFINE_OP(WideningOp::kNone    ,  0, k32), // kLoadN_U32.
  DEFINE_OP(WideningOp::kNone    ,  0, k64), // kLoadN_U64.
  DEFINE_OP(WideningOp::kNone    ,  0, k32), // kLoadN_F32.
  DEFINE_OP(WideningOp::kNone    ,  0, k64), // kLoadN_F64.
  DEFINE_OP(WideningOp::kU8ToU64 ,  2, kNA), // kLoadCvt16_U8ToU64.
  DEFINE_OP(WideningOp::kU8ToU64 ,  4, kNA), // kLoadCvt32_U8ToU64.
  DEFINE_OP(WideningOp::kU8ToU64 ,  8, kNA), // kLoadCvt64_U8ToU64.
  DEFINE_OP(WideningOp::kI8ToI16 ,  4, kNA), // kLoadCvt32_I8ToI16.
  DEFINE_OP(WideningOp::kU8ToU16 ,  4, kNA), // kLoadCvt32_U8ToU16.
  DEFINE_OP(WideningOp::kI8ToI32 ,  4, kNA), // kLoadCvt32_I8ToI32.
  DEFINE_OP(WideningOp::kU8ToU32 ,  4, kNA), // kLoadCvt32_U8ToU32.
  DEFINE_OP(WideningOp::kI16ToI32,  4, kNA), // kLoadCvt32_I16ToI32.
  DEFINE_OP(WideningOp::kU16ToU32,  4, kNA), // kLoadCvt32_U16ToU32.
  DEFINE_OP(WideningOp::kI32ToI64,  4, kNA), // kLoadCvt32_I32ToI64.
  DEFINE_OP(WideningOp::kU32ToU64,  4, kNA), // kLoadCvt32_U32ToU64.
  DEFINE_OP(WideningOp::kI8ToI16 ,  8, kNA), // kLoadCvt64_I8ToI16.
  DEFINE_OP(WideningOp::kU8ToU16 ,  8, kNA), // kLoadCvt64_U8ToU16.
  DEFINE_OP(WideningOp::kI8ToI32 ,  8, kNA), // kLoadCvt64_I8ToI32.
  DEFINE_OP(WideningOp::kU8ToU32 ,  8, kNA), // kLoadCvt64_U8ToU32.
  DEFINE_OP(WideningOp::kI16ToI32,  8, kNA), // kLoadCvt64_I16ToI32.
  DEFINE_OP(WideningOp::kU16ToU32,  8, kNA), // kLoadCvt64_U16ToU32.
  DEFINE_OP(WideningOp::kI32ToI64,  8, kNA), // kLoadCvt64_I32ToI64.
  DEFINE_OP(WideningOp::kU32ToU64,  8, kNA), // kLoadCvt64_U32ToU64.
  DEFINE_OP(WideningOp::kI8ToI16 , 16, kNA), // kLoadCvt128_I8ToI16.
  DEFINE_OP(WideningOp::kU8ToU16 , 16, kNA), // kLoadCvt128_U8ToU16.
  DEFINE_OP(WideningOp::kI8ToI32 , 16, kNA), // kLoadCvt128_I8ToI32.
  DEFINE_OP(WideningOp::kU8ToU32 , 16, kNA), // kLoadCvt128_U8ToU32.
  DEFINE_OP(WideningOp::kI16ToI32, 16, kNA), // kLoadCvt128_I16ToI32.
  DEFINE_OP(WideningOp::kU16ToU32, 16, kNA), // kLoadCvt128_U16ToU32.
  DEFINE_OP(WideningOp::kI32ToI64, 16, kNA), // kLoadCvt128_I32ToI64.
  DEFINE_OP(WideningOp::kU32ToU64, 16, kNA), // kLoadCvt128_U32ToU64.
  DEFINE_OP(WideningOp::kI8ToI16 , 32, kNA), // kLoadCvt256_I8ToI16.
  DEFINE_OP(WideningOp::kU8ToU16 , 32, kNA), // kLoadCvt256_U8ToU16.
  DEFINE_OP(WideningOp::kI16ToI32, 32, kNA), // kLoadCvt256_I16ToI32.
  DEFINE_OP(WideningOp::kU16ToU32, 32, kNA), // kLoadCvt256_U16ToU32.
  DEFINE_OP(WideningOp::kI32ToI64, 32, kNA), // kLoadCvt256_I32ToI64.
  DEFINE_OP(WideningOp::kU32ToU64, 32, kNA), // kLoadCvt256_U32ToU64.
  DEFINE_OP(WideningOp::kU8ToU64 ,  0, kNA), // kLoadCvtN_U8ToU64.
  DEFINE_OP(WideningOp::kI8ToI16 ,  0, kNA), // kLoadCvtN_I8ToI16.
  DEFINE_OP(WideningOp::kU8ToU16 ,  0, kNA), // kLoadCvtN_U8ToU16.
  DEFINE_OP(WideningOp::kI8ToI32 ,  0, kNA), // kLoadCvtN_I8ToI32.
  DEFINE_OP(WideningOp::kU8ToU32 ,  0, kNA), // kLoadCvtN_U8ToU32.
  DEFINE_OP(WideningOp::kI16ToI32,  0, kNA), // kLoadCvtN_I16ToI32.
  DEFINE_OP(WideningOp::kU16ToU32,  0, kNA), // kLoadCvtN_U16ToU32.
  DEFINE_OP(WideningOp::kI32ToI64,  0, kNA), // kLoadCvtN_I32ToI64.
  DEFINE_OP(WideningOp::kU32ToU64,  0, kNA), // kLoadCvtN_U32ToU64.
  DEFINE_OP(WideningOp::kNone    ,  1, k8 ), // kLoadInsertU8.
  DEFINE_OP(WideningOp::kNone    ,  2, k16), // kLoadInsertU16.
  DEFINE_OP(WideningOp::kNone    ,  4, k32), // kLoadInsertU32.
  DEFINE_OP(WideningOp::kNone    ,  8, k64), // kLoadInsertU64.
  DEFINE_OP(WideningOp::kNone    ,  4, k32), // kLoadInsertF32.
  DEFINE_OP(WideningOp::kNone    ,  8, k64), // kLoadInsertF32x2.
  DEFINE_OP(WideningOp::kNone    ,  8, k64)  // kLoadInsertF64.
};
...
static BL_NOINLINE Vec vec_neg(PipeCompiler* pc, const Vec& dst, const Vec& src, FloatMode fm) noexcept {
  AsmCompiler* cc = pc->cc;
...
void PipeCompiler::emit_2v(OpcodeVV op, const Operand_& dst_, const Operand_& src_) noexcept {
  ...
  switch (op) {
    ...
    case OpcodeVV::kRcpF64: {
      ...
      Vec one = simdVecConst(onePtr, dst);
      Vec src = as_vec(this, src_, dst);
...
void PipeCompiler::emit_2vi(OpcodeVVI op, const Operand_& dst_, const Operand_& src_, uint32_t imm) noexcept {
  ...
  switch (op) {
    ...
    case OpcodeVVI::kSrlbU128: {
      ...
      vec_set_type(dst, opInfo.dstElement);
      vec_set_type(src, opInfo.dstElement);
      vec_set_type(zero, opInfo.dstElement);
...
void PipeCompiler::emit_3v(OpcodeVVV op, const Operand_& dst_, const Operand_& src1_, const Operand_& src2_) noexcept {
  ...
  switch (op) {
    ...
    case OpcodeVVV::kCmpUnordF64: {
      if (isSameVec(src1, src2_)) {
        emit_3v_op(this, instId, dst, src1, src1, opInfo.floatMode, opInfo.dstElement, opInfo.dstPart, opInfo.srcElement, opInfo.srcPart, 0);
      }
      else {
        Vec src2 = as_vec(this, src2_, dst, opInfo.floatMode);
        Vec tmp = newSimilarReg(dst, "@tmp");

        emit_3v_op(this, instId, tmp, src1, src1, opInfo.floatMode, opInfo.dstElement, opInfo.dstPart, opInfo.srcElement, opInfo.srcPart, 0);
        emit_3v_op(this, instId, dst, src2, src2, opInfo.floatMode, opInfo.dstElement, opInfo.dstPart, opInfo.srcElement, opInfo.srcPart, 0);

        cc->and_(dst.b16(), dst.b16(), tmp.b16());
      }
    ...
    case OpcodeVVV::kHAddF64: {
      ...
      if (src1.id() == src2.id()) {
        cc->ext(tmp.d2(), src1.d2(), src1.d2(), 8);
